...
//                    $to_email = Settings('email');
                    $to_email = 'Banglademy4u@gmail.com';
                } else {
                    $to_email = $user->email;
    ...
    function Settings($value = null)
    {
        try {
            if ($value == "frontend_active_theme") {
                return Cache::rememberForever('frontend_active_theme', function () {
...
if (!function_exists('countryWishTaxRate')) {
    function countryWishTaxRate()
    {
        ...
        if (Auth::check()) {
            ...
            $countryWishTaxList = Cache::rememberForever('countryWishTaxList', function () {
...
//                $message [$attribute . '.' . $string[0]] = __('validation.' . $attribute . '.' . $string[0]);
                $message [$attribute . '.' . $string[0]] = __('The ' . $attribute . ' Field is ' . $string[0]);
            }
        }
...
if (!function_exists('GenerateGeneralSetting')) {
    function GenerateGeneralSetting()
    {
...
if (!function_exists('getIpBlockList')) {
    ...
    {
        Cache::rememberForever('ipBlockList', function () {
            $data = [];
