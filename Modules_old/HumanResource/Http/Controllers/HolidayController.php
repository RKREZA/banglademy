...
use Modules\HumanResource\Repositories\HolidayRepository;
...
class HolidayController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('humanresource::leave.holiday_setup.index')->with($data);
    }
    ...
    public function addRow(Request $request)
    {
        ...
        if ($year)
            return view('humanresource::leave.holiday_setup.row',compact('year','holidays'));
        else
            return view('humanresource::leave.holiday_setup.row',compact('year','holidays'));
    }
    ...
    public function getLastYearData(Request $request)
    {
        try {
            ...
            return view('humanresource::leave.holiday_setup.components.edit')->with($data);
