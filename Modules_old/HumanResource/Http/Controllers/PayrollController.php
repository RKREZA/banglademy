...
use Modules\HumanResource\Http\Requests\PayrollReportFormRequest;
use Modules\HumanResource\Http\Requests\PayrollFilterFormRequest;
use Modules\HumanResource\Repositories\PayrollRepository;
...
class PayrollController extends Controller
{
    ...
    public function index()
    {
    	try{
        	...
        	return view('humanresource::payroll.payrolls.index', compact('months'));
    	}
    	catch(\Exception $e)
    	{
    ...
    {
        return view('humanresource::payroll.create');
    }

    public function show($id)
    {
        return view('humanresource::payroll.show');
    }

    public function edit($id)
    {
        return view('humanresource::payroll.edit');
    }
    ...
    public function search_for_payroll(PayrollFilterFormRequest $request)
    {
        try {
            ...
            $y = $request->year;
            $months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
            return view('humanresource::payroll.payrolls.index',[
                'users' => $users,
                'r' => $r,
                'm' => $m,
                'y' => $y,
    ...
    public function generatePayroll(Request $request, $id, $payroll_month, $payroll_year)
	{
		try{
			...
			return view('humanresource::payroll.payrolls.generatePayroll', compact('staffDetails', 'payroll_month', 'payroll_year', 'p', 'l', 'a', 'f', 'h', 'loans'));
		}catch (\Exception $e) {
	...
	public function paymentPayroll(Request $request)
	{
		try{
			...
			return view('humanresource::payroll.payrolls.paymentPayroll', compact('payrollDetails', 'role_id'));
		}catch (\Exception $e) {
			\LogActivity::errorLog($e->getMessage());
		   Toastr::error('Operation Failed', 'Failed');
		   return redirect()->back();
	...
	public function viewPayslip(Request $request)
	{
		try{
			...
			return view('humanresource::payroll.payrolls.viewPayslip', compact('payrollDetails', 'payrollEarnDetails', 'payrollDedcDetails'));
		}catch (\Exception $e) {
		   Toastr::error('Operation Failed', 'Failed');
		   return redirect()->back();
		}
    ...
    {
        $months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
        return view('humanresource::payroll.payroll_reports.payroll', compact('months'));
    }
    ...
    public function searchPayrollReport(PayrollReportFormRequest $request)
    {
		try{
			...
			return view('humanresource::payroll.payroll_reports.payroll', compact('months', 'm', 'y', 'r', 'payrolls'));
		}catch (\Exception $e) {
			\LogActivity::errorLog($e->getMessage());
		   Toastr::error('Operation Failed', 'Failed');
		   return redirect()->back();
    ...
    public function getPdf($id)
    {
        try {
			...
			return $this->getPayroll('humanresource::payroll.payrolls.viewPayslip', $payrollDetails);
        } catch (\Exception $e) {
            \LogActivity::errorLog($e->getMessage());
