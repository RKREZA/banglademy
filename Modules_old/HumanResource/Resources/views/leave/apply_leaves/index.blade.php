        ...
        <div class="container-fluid p-0">
            <div class="row justify-content-center">
                ...
                @php
                    ...
                    $extra_leave_days =  0;
                    $total_leave_days =  $total_leave + (\Illuminate\Support\Facades\Auth::user()->staff->carry_forward ?? 0);
...
{{--                                                        @if (permissionCheck('languages.edit_modal'))--}}
                                                            ...
                                                            @else
                                                                <a href="#"
                                                                   class="dropdown-item">{{__('leave.Approved')}}</a>
                                                            @endif
{{--                                                        @endif--}}
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <select class="primary_select mb-25" name="leave_type_id" id="leave_type_id"
                                            required>
                                        @foreach (\Modules\HumanResource\Entities\LeaveType::Active()->get() as $leave_type)
