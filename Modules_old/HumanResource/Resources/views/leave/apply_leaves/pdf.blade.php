...
<div class="invoice_heading">
    <div class="invoice_logo">
        <img src="{{asset(Settings('logo') ?? 'uploads/settings/logo.png')}}" width="100px" alt="">
    </div>
    ...
    <div class="invoice_logo">
        <table class="table-borderless">
            ...
            <tr>
                ...
                <td><b>:</b></td>
                <td><a href="tel:{{Settings('phone')}}">{{Settings('phone')}}</a></td>
            </tr>
            <tr>
                <td><b>{{__('common.Email')}}</b></td>
                <td><b>:</b></td>
                <td><a href="mailto:{{Settings('email')}}">{{Settings('email')}}</a>
                </td>
            </tr>
            <tr>
                <td><b>{{__('payroll.Address')}}</b></td>
                <td><b>:</b></td>
                <td><a href="">{{Settings('address')}}</a></td>
            </tr>
        </table>
    </div>
    <div class="invoice_logo">
