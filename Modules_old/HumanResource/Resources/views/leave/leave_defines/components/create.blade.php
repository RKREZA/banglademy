                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 role_id">
                                <div class="primary_input mb-25">
                                    ...
                                    <select onchange="getUserByRole(this)" class="primary_select mb-25" name="role_id" id="role_id">
                                        <option value="">{{__('leave.Choose One')}}</option>
                            ...
                            <div class="col-lg-12 user_id">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label"
                                           for="user_id">{{ __('leave.Select User') }}</label>
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <select class="primary_select mb-25" name="leave_type_id" id="leave_type_id">
                                        <option selected value="">{{__('leave.Choose One')}}</option>
                            ...
                            <div class="col-xl-3">
                                <div class="primary_input mb-25">
                                    ...
                                    <ul id="balance_forward_checkbox" class="permission_list sms_list ">
                                        <li>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="primary_input mb-25">
                                            ...
                                            <ul id="adjust_checkbox" class="permission_list sms_list ">
                                                <li>
                                                    <label data-id="bg_option"
                                                           class="primary_checkbox d-flex mr-12">
                                    ...
                                    <div class="col-xl-6 displayNone specific_year">
                                        <div class="primary_input mb-25">
                                            ...
                                            <ul id="only_this_year_checkbox" class="permission_list sms_list ">
                                                <li>
                                                    <label data-id="bg_option"
                                                           class="primary_checkbox d-flex mr-12">
