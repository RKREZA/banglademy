    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            <div class="row justify-content-center">
                <div class="col-lg-12 holiday_setup">
                    ...
                    <div class="QA_section QA_section_heading_custom check_box_table mt-80">
                        <div class="QA_table">
                            <!-- table-responsivaae -->
                            <div class="">
                                @include('humanresource::leave.holiday_setup.components.table')
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 {{ isset($edit) ? 'mt-30' : '' }}">
                    @if(isset($edit))
                        <div class="white_box">
                            <div class="row p-0">
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <select name="year" onchange="lastYearData()" class="primary_select last_year">
                                            <option value="">{{ trans('common.Select One') }}</option>
                                            @isset($holiday)
                            ...
                            <form class="" action="{{ route('holidays.store') }}" method="POST">@csrf
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="">{{ __('holiday.Select Year') }}</label>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    @include('humanresource::leave.holiday_setup.components.row')
                                    @if (session()->has('holidays'))
                                        @include('humanresource::leave.holiday_setup.components.session')
                                    @else
                                        @if(permissionCheck('holydays.index'))
                                            @include('humanresource::leave.holiday_setup.components.edit')
                                        @endif
                                    @endif
                                    </tbody>
                                </table>
                    ...
                    @else
                        @if($holiday)
                            @include('humanresource::leave.holiday_setup.components.view')
                        @endif
                    @endif
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="d-flex justify-content-center pt_20">
                                        <button type="submit" class="primary-btn semi_large2 fix-gr-bg" id="save_year"><i
                                                class="ti-check"></i>
                                            {{ __('common.Save') }}
                                        </button>
                                    </div>
