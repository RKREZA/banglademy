      ...
      <div class="container-fluid">
         <table  cellspacing="0" width="100%">
            <tr>
               ...
               <td width="25" style="text-aligh:center">
                   @if(!isset($instructor))
                    <p style="font-size:14px !important; border-bottom:1px solid gray" align="left" class="text-white">@lang('courses.Course'): {{ $course->title}} </p>
                   @endif
         ...
         <h3 style="text-align:center">
             @if(isset($instructor)) @lang('instructor.Instructor') @else @lang('common.Staff') @endif
             @lang('attendance.Attendance Report')
         </h3>
