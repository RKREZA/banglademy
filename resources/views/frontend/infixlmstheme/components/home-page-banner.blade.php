    ...
    @if($homeContent->show_banner_section==1)
        <form action="{{route('search')}}">
            <div class="banner_area"
                 ...
                 style="background-image: url('{{asset(@$homeContent->slider_banner)}}'); padding: 110px 0 130px; "
                @endif>
                <div class="container">
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-9 offset-lg-1">
                            <div class="banner_text" >
                                <h3 style="max-width: 670px; font-size: 40px; line-height: 65px; font-family: 'Hind Siliguri', sans-serif">{{@$homeContent->slider_title}}</h3>
                                <p style="font-family: 'Hind Siliguri', sans-serif" >{{@$homeContent->slider_text}}</p>
