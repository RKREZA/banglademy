<div>
    @if($cookie)
        ...
        <div class="theme_cookies" style="display: none; justify-content: left; grid-gap: 5px; width:630px; padding: 10px 10px 10px 10px;">
            <div class="theme_cookies_info" style="grid-gap: 5px">
