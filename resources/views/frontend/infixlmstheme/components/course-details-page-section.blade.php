<div>
    ...
    <div class="course__details" style="padding-top: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-xl-9 col-lg-9 align-self-start">
                    <div class=" mb-3">
                        <h3 style="font-size: 40px;">{{$course->title}}</h3>
                    </div>
                </div>
                ...
                <div class="col-xl-9 col-lg-9">
                    <div style="background-image: none;" class="video_screen  mb_30">
                        @if($course->host=="Vimeo")
                            <iframe src="https://player.vimeo.com/video/{{getVideoId(showPicName(@$course->trailer_link))}}/?autoplay=0&amp;color=white&amp;loop=false&amp;controls=true&amp;title=0&amp;rel=0&amp;end=60" allowfullscreen="" frameborder="0" width="600"></iframe>
                        @else
                            <iframe src="https://player.vimeo.com/video/{{getVideoId(showPicName(@$course->trailer_link))}}/?autoplay=0&amp;color=white&amp;loop=false&amp;controls=true&amp;title=0&amp;rel=0&amp;end=60" allowfullscreen="" frameborder="0" width="600"></iframe>
                        @endif
...
{{--                                                                                                data-url="{{route('quizStart',[$course->id,$quiz->id,$quiz->title])}}"--}}
                                ...
                                <div class="tab-pane fade " id="Instructor" role="tabpanel"
                                    ...
                                    <div class="author_courses">
                                        ...
                                        <div class="row">
                                            @foreach(@$course->user->courses->take(3) as $c)
                                                        ...
                                                        <a href="{{courseDetailsUrl(@$c->id,@$c->type,@$c->slug)}}">
                                                            <div class="thumb">
                                                                ...
                                                                <div class="thumb_inner lazy"
                                                                     data-src="{{ file_exists($c->thumbnail) ? asset($c->thumbnail) : asset('public/\uploads/course_sample.png') }}">
                                                                </div>
                                                            </div>
                                                        </a>
                                                        <div class="course_content" style="padding: 20px;">
                                                            ...
                                                            <div class="rating_star mb-2" style="display: flex;">
                                                                ...
                                                                <div class="stars mr-3">
                                                                    @php
                                                                        $userRating = userRating($c->user_id);
                                                                        $main_stars= $userRating['rating'] ;
                                                            ...
                                                            <div class="course_less_students mb-1" style="display: flex; height: 26px; ">
                                                                @if(!empty($c->discount_price))
                                                                    <p style="font-weight: 500; font-family: 'Hind Siliguri', sans-serif; color: #f57224;">{{( ceil($c->price-$c->discount_price)/$c->price*100) }}% off</p>
                                                            ...
                                                            <a href="" class=" d-flex justify-content-center theme_btn btn-block cart_store" style="border-radius: 0; padding: 15px 0; letter-spacing: 1px;"  data-id="{{$c->id}}">
                                                                <i class="fas fa-shopping-cart mr-2"></i>{{empty($c->discount_price)?$c->price:$c->discount_price}} TK
                                                            </a>
                                                        ...
                                                        <div class="couse_wizged" style=" box-shadow: 0 10px 15px 0 rgb(0 0 0 / 5%);">
                                                            <a href="{{courseDetailsUrl(@$r->id,@$r->type,@$r->slug)}}">
                                                                <div class="thumb">
                                                                    ...
                                                                    <div class="thumb_inner lazy"
                                                                         data-src="{{ file_exists($r->thumbnail) ? asset($r->thumbnail) : asset('public/\uploads/course_sample.png') }}">
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <div class="course_content" style="padding: 20px;">
                                                                <a href="{{courseDetailsUrl(@$r->id,@$r->type,@$r->slug)}}">
                                                                    ...
                                                                    <h4 class="noBrake" title=" {{$r->title}}">
                                                                        {{$r->title}}
                                                                    </h4>
                                                                </a>
                                                                <div class="rating_star mb-2" style="display: flex;">
                                                                    ...
                                                                    <div class="stars mr-3">
                                                                        @php
                                                                            $userRating = userRating($r->user_id);
                                                                            $main_stars= $userRating['rating'] ;
                                                                ...
                                                                <div class="course_less_students mt-3 mb-3">
                                                                    <a> <i class="ti-agenda"></i> {{count($r->lessons)}}
                                                                        {{__('frontend.Lessons')}}</a>
                                                                    <a>
                                                                        <i class="ti-user"></i> {{$r->total_enrolled}} {{__('frontend.Students')}}
                                                                    </a>
                                                                </div>
                                                                <div class="course_less_students mb-1" style="display: flex; height: 26px; ">
                                                                    @if(!empty($r->discount_price))
                                                                        <p style="font-weight: 500; font-family: 'Hind Siliguri', sans-serif; color: #f57224;">{{( ceil($r->price-$r->discount_price)/$r->price*100) }}% off</p>
                                                                        <p style="text-decoration: line-through; color: #9e9e9e; padding-left: 7px">
                                                                            {{$r->price}} TK</p>
                                                                    @else
                                                                    @endif
                                                                ...
                                                                <a href="" class=" d-flex justify-content-center theme_btn btn-block cart_store" style="border-radius: 0; padding: 15px 0; letter-spacing: 1px;"  data-id="{{$r->id}}">
                                                                    <i class="fas fa-shopping-cart mr-2"></i>{{empty($r->discount_price)?$r->price:$r->discount_price}} TK
                                                                </a>
                ...
                <div class="col-xl-3 col-lg-3">
                    <div class="sidebar__widget mb_30">
                        <div class="sidebar__title" style="margin-bottom: 10px;">
                            <h3>
                        ...
                        <div class="sidebar__title">
                            @if(!empty($course->discount_price))
                                <h4 style="  font-weight: 500; color: #f57224; ">{{( ceil($course->price-$course->discount_price)/$course->price*100) }}% Off</h4>
                                <h4 style="text-decoration: line-through; font-weight: 500; color: #9e9e9e; padding-left: 7px;">{{getPriceFormat($course->price)}}</h4>
                            @else
                            @endif
                        </div>
                        ...
                        <h4 class="f_w_700 mb_20">{{__('frontend.This course includes')}}:</h4>
                        <ul class="course_includes">
                            <li class="mb-4"><i class="ti-alarm-clock"></i>
                                <p class="nowrap"> {{ __('frontend.Duration') }} {{MinuteFormat($course->duration)}}

                                </p></li>
                            <li class="mb-4"><i class="ti-thumb-up"></i>
