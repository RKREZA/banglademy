            ...
            <div class="order_wrapper">
                ...
                <div class="bank_transfer">
                    <div class="form-check form-check-inline mb-5">
                        <input class="form-check-input" type="checkbox" id="checkbox" name="checkbox" value="checked" required>
                        <label class="form-check-label" for="checkbox">
                            I agree to the <a href="{{url('https://banglademy.net/pages/terms-and-conditions')}}">terms and conditions</a>
                            and <a href="{{url('https://banglademy.net/pages/refund-policy')}}">refund policy</a>
                        </label>
                    </div>
