...
<!-- Google / Search Engine Tags -->
    ...
    <meta property="og:image" content="{{asset('/').'public/frontend/bd_logo.png'}}"/>
    <meta property="og:image:type" content="image/png"/>


    @if(routeIs('blogDetails'))
        <meta itemprop="title" content="@yield('meta_title')">
    ...
    <style>
        * {
        ...
        @media (max-width:767.98px) {
            .header_area .contact_wrap .theme_btn2.small_btn2 {
                padding: 10px 18px;
                font-size: 14px
            }
        }
