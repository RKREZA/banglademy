                ...
                <div class="col-12">
                    <div class="header__wrapper">
                        ...
                        <div class="header__left d-flex align-items-center">
                            <div class="logo_img">
                                <a href="{{url('/')}}">
                                    <img class="p-2" style="width: 150px" src="{{getCourseImage(Settings('logo') )}}"
                            ...
                            <nav>
                                ...
                                <ul id="mobile-menu">
                                    ...
                                    <li id="mobileLoginBtn" >
                                        <a href="{{url('login')}}">{{__('frontend.Sign In')}} </a>
                                    </li>
                                    @endguest
                                    @if(isset($menus))
                            ...
                            <div class="header__right login_user">
                                <div class="profile_info collaps_part">
                                    <div class="profile_img collaps_icon d-flex align-items-center">
                                        <div class="studentProfileThumb" style="background-image: url('{{getProfileImage(Auth::user()->image)}}')"></div>
                            ...
                            <div class="header__right">
                                <div class="contact_wrap d-flex align-items-center">
                                    <div class="contact_btn" >
                                        <a href="{{url('register')}}"
                                           class="theme_btn small_btn2 mr-2">{{__('Get Started')}} </a>
                                    </div>

                                    <div class="contact_btn " id="loginBtn">
                                        <a href="{{url('login')}}"
                                           class="theme_btn2 small_btn2">{{__('frontend.Sign In')}} </a>
                                    </div>
                                </div>
                            </div>
                        @endguest
