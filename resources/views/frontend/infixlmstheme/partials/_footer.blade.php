...
<footer class="{{Settings('footer_show')==0?'d-none d-sm-none d-md-block d-lg-block d-xl-block':''}}">
    ...
    @endif
    <div class="copyright_area" style="padding-bottom: 0;">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="footer_widget d-flex justify-content-center">
                        <img style="width: 50%" src="{{asset('/').'public/frontend/ammarpay-footer-logo.png'}}" alt="ammarpay_logo">
                    </div>
                </div>
            </div>
...
<!-- UP_ICON  -->
<div id="back-top" style="display: none; right: 120px; bottom: 40px;">
...
<script>
    ...
    chatbox.setAttribute("page_id", "111887274333352");
