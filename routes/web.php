...
////         (new App\Http\Controllers\PaymentController)->paymentTranCheck();
//    });
...
//aamarpay url
Route::post('/order/aamarpay/success', 'PaymentController@aamarpaySuccess')->name('aamarpaySuccess');
Route::post('/order/aamarpay/failed', 'PaymentController@aamarpayFailed')->name('aamarpayFailed');
Route::get('/order/aamarpay/cancel', 'PaymentController@aamarpayFailed')->name('aamarpayCancel');
...
//    //aamarpay url
//    Route::post('/aamarpay/success', 'PaymentController@aamarpaySuccess')->name('aamarpaySuccess');
//    Route::post('/aamarpay/failed', 'PaymentController@aamarpayFailed')->name('aamarpayFailed');
//    Route::get('/aamarpay/cancel', 'PaymentController@aamarpayFailed')->name('aamarpayCancel');
