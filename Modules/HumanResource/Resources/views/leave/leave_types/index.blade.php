...
@section('mainContent')
    <section class="admin-visitor-area up_st_admin_visitor">
        ...
        @include('humanresource::leave.leave_types.components.create')
        @include('backend.partials._deleteModalForAjax',['item_name' => 'Leave Type'])
                                ...
                                <ul class="d-flex">
                                    <li>
                                        <button class="primary-btn radius_30px mr-10 fix-gr-bg"
                                                ...
                                                class="ti-plus"></i>{{ __('common.Add New') }} {{ __('leave.Leave Type') }}
                                        </button>
                                    </li>
                                </ul>
                            @endif
                    ...
                    <div class="QA_section QA_section_heading_custom check_box_table">
                        <div class="QA_table">
                            <div class="" id="item_table">
                                {{-- Leave Type List --}}
                                @include('humanresource::leave.leave_types.components.list')
                            </div>
                        </div>
                    </div>
                </div>
