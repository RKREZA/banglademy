                                 ...
                                 @isset($loans)
                                         ...
                                         @foreach ($loans as $key => $loan)
                                             ...
                                             <tr id="DeductionRow{{ $key+1 }}">
                                                 <td width="60%" class="pr-30">
                                                     <div class="input-effect mt-10">
                                                         <input class="primary-input form-control" type="text" id="deductionstype0" name="deductionstype[]" value="{{ $loan->title }} - {{ __('payroll.Loan') }}" readonly>
                                                 ...
                                                 <td width="20%">
                                                     <div class="input-effect mt-10">
                                                         ...
                                                         <input type="checkbox" id="checkbox0" value="1" name="loanStatus[]" checked>
                                                         <span class="focus-border"></span>
                                                     </div>
                                                 </td>
                                             </tr>
                                     ...
                                     @else
                                         <tr id="DeductionRow0">
                                             ...
                                             <td width="20%">
                                                 <div class="input-effect mt-10">
                                                     <label for="deductionsstatus0">{{ __('payroll.Loan Status') }}</label>
                                                     <input type="checkbox" class='primary-input form-control' id="checkbox0" value="0">
                                                 </div>
                                             </td>
                                         </tr>
                                     @endif
...
@push('scripts')
    ...
    // for minus staff deductions in payroll
     function addDeductions(){
        ...
        var table_len = (table.rows.length);
        var id = parseInt(table_len);
        var row = table.insertRow(table_len).outerHTML = "<tr id='DeductionRow" + id + "'><td width='50%' class='pr-30'><div class='input-effect mt-10'><input class='primary-input form-control has-content' type='text' id='deductionstype" + id + "' name='deductionstype[]'><label for='deductionstype" + id + "'>Type</label><span class='focus-border'></span></div></td><td width='20%'><div class='input-effect mt-10'><input class='primary-input form-control has-content' oninput='this.value = Math.abs(this.value)' type='number' id='deductionsValue" + id + "' name='deductionsValue[]'><label for='deductionsValue" + id + "'>Value</label><span class='focus-border'></span></div></td><td width='10%'><div class='input-effect mt-10'><input class='read-only-input has-content' type='checkbox' id='loanStatus" + id + "' name='loanStatus[]'></div></td><td width='10%' class='pt-30'><button type='button' class='primary-btn icon-only fix-gr-bg close-deductions' onclick='delete_deduction(" + id + ")'><span class='ti-close'></span></button></td></tr>";
    }
