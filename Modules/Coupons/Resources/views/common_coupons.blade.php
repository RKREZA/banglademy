    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>{{__('coupons.Common Coupons List')}}</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">{{__('common.Dashboard')}}</a>
                    <a href="#">{{__('coupons.Course')}}</a>
                    <a class="active"
                       href="{{route('coupons.manage')}}">{{__('coupons.Common')}} {{__('coupons.Coupons')}}</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box_header common_table_header">
                                <div class="main-title d-md-flex">
                                    <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"> @if(!isset($edit)) {{__('coupons.Add New Coupons') }} @else {{__('coupons.Update Coupons')}} @endif</h3>
                                    @if(isset($edit))
                                        @if (permissionCheck('coupons.common.store'))
                                            <a href="{{route('coupons.manage')}}"
                                               class="primary-btn small fix-gr-bg">+ {{__('coupons.Add')}}</a>
                                        @endif
                                    @endif
                                </div>
                            </div>
                ...
                <div class="col-lg-9 ">
                    <div class="main-title">
                        <h3 class="mb-20">{{__('coupons.Common Coupons List')}}</h3>
                    </div>
                                ...
                                <table id="lms_table" class="table Crm_table_active3">
                                    ...
                                    @foreach($coupons as $key => $coupon)
                                        <tr>
                                            ...
                                            <td>{{@$coupon->title }}</td>
                                            <td>{{@$coupon->code }}</td>
                                            <td>{{ getPriceFormat($coupon->value)  }}</td>
