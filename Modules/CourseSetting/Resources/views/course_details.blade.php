                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="checkbox_wrap d-flex align-items-center mt-40">
                                                                <label for="upcoming_course_2{{$course->id}}" class="switch_toggle  mr-2">
                                                                    <input type="checkbox" class="upcoming_course_2"
                                                                           id="upcoming_course_2{{$course->id}}"
                                                                           name="upcoming"
                                                                           @if ($course->upcoming==1) checked @endif
                                                                           value="1">
                                                                    {{-- <input type="checkbox" class="edit_course_2" id="edit_course_2" name="is_free" @if ($course->price==0) checked @endif value="1"> --}}
                                                                    <i class="slider round"></i>
                                                                </label>
                                                                <label class="mb-0">{{__('This course is upcoming')}}</label>
                                                            </div>
                                                        </div>
                                                    </div>
